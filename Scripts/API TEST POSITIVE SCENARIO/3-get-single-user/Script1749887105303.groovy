...
// get API response
def response = WS.sendRequest(findTestObject('API Method/3-get-single-user', [('baseUrl') : GlobalVariable.baseURL, ('apiKey') : GlobalVariable.apiKey, ('id_user') : GlobalVariable.idUser]))
